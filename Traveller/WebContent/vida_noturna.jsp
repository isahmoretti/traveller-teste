...
<body>
 <!-- Top Bar -->
  ...
  <!--Fim do menu-->
  <div>
    <img src="assets/images/vida-noturna.svg" class="card-img" alt="Ilustração de um show">
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        ...
                        <li class="blog-post-text"><i class="fas fa-music"></i> Música eletrônica</li>
                        <li class="blog-post-text"><i class="fas fa-smoking"></i></i> Tem fumódromo</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="far fa-lightbulb"></i> Iluminação LED</li>
                        <li class="blog-post-text"><i class="fas fa-money-bill-wave"></i> R$ 40 até R$ 160</li>
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        ...
                        <li class="blog-post-text"><i class="fas fa-water"></i> Piscina no terraço</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="far fa-image"></i></i> Uma vista única</li>
                        <li class="blog-post-text"><i class="fas fa-money-bill-wave"></i> R$ 60 até R$ 100</li>
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-glass-cheers"></i> Bar</li>
                        <li class="blog-post-text"><i class="fas fa-cocktail"></i> Bons drinks</li>
                        <li class="blog-post-text"><i class="fas fa-building"></i> 30º andar</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                ...
                <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-glass-cheers"></i> Bar</li>
                        <li class="blog-post-text"><i class="fas fa-guitar"></i> Música ao vivo</li>
                        <li class="blog-post-text"><i class="fas fa-beer"></i> O melhor chopp</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
         ...
         <img src="assets/images/cafe-piu-piu.jpg" class="img-card img-fluid rounded-start"
              ...
              <div class="col-md-8">
                ...
                <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Café Piu Piu</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-globe"></i> Casa Noturna</li>
                        <li class="blog-post-text"><i class="fas fa-cocktail"></i> Bons drinks</li>
                        <li class="blog-post-text"><i class="fas fa-heart"></i> Decoração diferente</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-subway"></i> Fácil acesso ao metrô</li>
                        <li class="blog-post-text"><i class="fas fa-money-bill-wave"></i> R$ 60 até R$ 100</li>
                        <li class="blog-post-text"><i class="fas fa-sun"></i> Vai até o nascer do sol</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
                        class="px-4 btn botao">Saiba
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        ...
                        <li class="blog-post-text"><i class="fas fa-cocktail"></i> Bons drinks</li>
                        <li class="blog-post-text"><i class="fas fa-star"></i> Atrações ilustres</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
    ...
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/emporio-alto-dos-pinheiros.jpg" class="img-card img-fluid rounded-start"
                  alt="Empório Alto dos Pinheiros">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Empório Alto dos Pinheiros</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>

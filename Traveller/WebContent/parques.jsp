...
<head>
  ...
  <link rel="stylesheet" href="assets/css/style.css">
   ...
   <script src="assets/js/script_parques.js"></script>
  <title>Parques</title>
</head>
...
<body>
  ...
  <!--Fim do menu-->
  <div>
    <img src="assets/images/parques.svg" class="card-img" alt="Ilustração das árvores de um parque">
    <h1 class="titulo__paginas text-center py-3">Parques</h1>
  </div>
  ...
  <section class="my-5 container shadow-sm py-4 border pesquisa">
    <div class="row d-flex justify-content-center g-3 py-3 px-4">
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-4 py-2">
        <input type="text" class="form-control" placeholder="Nome do parque" aria-label="nomeParque" id=nomeParque">
      </div>
      <div class="col-12 col-sm-6 col-md-4 col-lg-4 py-2">
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" id="boxcard" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/Parque-Buenos-Aires-1.jpeg" class="img-card img-fluid rounded-start"
                  alt="Parque Buenos Aires">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fa-tree"></i> Árvores históricas</li>
                        <li class="blog-post-text"><i class="fas fa-apple-alt"></i> Área para piquenique</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class=" icon_parque fas fa-wheelchair"></i> Entrada com
                          acessivel</li>
                        <li class="blog-post-text"><i class="fas fa-dog"></i> Bom para cães</li>
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/parque-do-ibirapuera-3.jpeg" class="img-card img-fluid rounded-start"
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">5,0 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-bicycle"></i> Bom para pedalar</li>
                        <li class="blog-post-text"><i class="fas fa-skating"></i> Bom para andar de patins</li>
                        <li class="blog-post-text"><i class="fas fa-volleyball-ball"></i> Tem quadras</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/parque-villa-lobos-sp.jpeg" class="img-card img-fluid rounded-start"
                  alt="Parque Villa Lobos">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Parque Villa Lobos</h5>
                  <p class="card-text">4,0 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fa-book"></i> Tem biblioteca</li>
                        <li class="blog-post-text"><i class="fas fa-apple-alt"></i> Área para piquenique</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class=" icon_parque fas fa-wheelchair"></i> Entrada com
                          acessivel</li>
                        <li class="blog-post-text"><i class="fas fa-seedling"></i> Tem orquidários</li>
                        <li class="blog-post-text"><i class="fas fa-child"></i> Bom para crianças</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
       <img src="assets/images/parque-da-agua-branca.jpeg" class="img-card img-fluid rounded-start"
                  alt="Parque Agua Branca">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Parque da Água Branca</h5>
                  <p class="card-text">3,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fa-tree"></i> Árvores históricas</li>
                        <li class="blog-post-text"><i class="fas fas fa-tree"></i> Tem trilha</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class=" icon_parque fas fa-wheelchair"></i> Entrada com
                          acessivel</li>
                        <li class="blog-post-text"><i class="fas fa-paw"></i> Não pode entrar cães</li>
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
        <img src="assets/images/parque-burle-marx.jpeg" class="img-card img-fluid rounded-start"
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Parque Burle Marx</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fas fa-tree"></i> Trilhas arborizadas</li>
                        <li class="blog-post-text"><i class="fas fas fa-seedling"></i> Possui horta comunitária</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class=" icon_parque fas fa-wheelchair"></i> Entrada com
                          acessivel</li>
                        <li class="blog-post-text"><i class="fas fa-dog"></i> Bom para cães</li>
                        <li class="blog-post-text"><i class="fas fa-camera-retro"></i> Perfeito para ensaios</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
                        class="px-4 btn btn-primary">Saiba
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
       <img src="assets/images/parque-da-independencia.jpeg" class="img-card img-fluid rounded-start"
                  alt="Parque da Independência">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <p class="card-text">3,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fa-tree"></i> Árvores históricas</li>
                        <li class="blog-post-text"><i class="fas fa-tint"></i> Tem chafariz com fonte</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class=" icon_parque fas fa-wheelchair"></i> Entrada com
                          acessivel</li>
                        <li class="blog-post-text"><i class="fas fa-dog"></i> Bom para cães</li>
                        <li class="blog-post-text"><i class="fas fa-skating"></i> Bom para andar de skate</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
                        class="px-4 btn btn-primary">Saiba
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
        <img src="assets/images/parque-da-juventude-carandiru.jpeg" class="img-card img-fluid rounded-start"
                  alt="Parque da Juventude">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Parque da Juventude</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fa-table-tennis"></i> Tem quadra de tênis</li>
                        <li class="blog-post-text"><i class="fas fa-apple-alt"></i> Área para piquenique</li>
                      </ul>
                    </div>
                    <div class="float-right">
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
        <img src="assets/images/parque-da-aclimacao.jpeg" class="img-card img-fluid rounded-start"
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Parque da Aclimação</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fa-tree"></i> Árvores históricas</li>
                        <li class="blog-post-text"><i class="fas fa-leaf"></i> Jardim japonês</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class=" icon_parque fas fa-wheelchair"></i> Entrada com
                          acessivel</li>
                        <li class="blog-post-text"><i class="fas fa-spa"></i> Aulas de yoga</li>
                        <li class="blog-post-text"><i class="fas fa-child"></i> Bom para crianças</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
        <img src="assets/images/parque-ecologico-tiete.jpeg" class="img-card img-fluid rounded-start"
                  alt="Parque Ecológico do Tietê">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Parque Ecológico do Tietê</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-dumbbell"></i> Aparelhos de ginástica</li>
                        <li class="blog-post-text"><i class="fas fa-crow"></i> Tem animais silvestres</li>
                        <li class="blog-post-text"><i class="fas fa-water"></i> Tem pedalinho</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
...
<section class="py-3">
  <div class="card-espaco card mb-3 shadow-sm" style="max-width: 760px;">
    <div class="row g-0">
      <div class="col-md-4">
        <img src="assets/images/parque-trianon.jpeg" class="img-card img-fluid rounded-start" alt="Parque Trianon">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <span class=" btn-outline-secondary circulo py-2 px-3 mx-1 float-right border"><i
                  ...
                  <span class=" py-2 btn-outline-secondary px-2 circulo float-right"><i
                      class=" curtir far fa-heart"></i></span>
                  <h5 class="card-title">Parque Trianon</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>

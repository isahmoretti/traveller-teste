...
<body>
  ...
  <!--Fim do menu-->
  <div>
    <img src="assets/images/cultura.svg" class="card-img" alt="Ilustração de um casal no museu">
    <h1 class="titulo__paginas text-center py-3">Cultura</h1>
  </div>

  <!--Início Buscador-->
  <section class="my-4 container shadow-sm py-4 border pesquisa">
    <div class="row d-flex justify-content-center g-3 py-3 px-4">
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-4 py-2">
        <select class="form-select form-control" name="tipoEstabelecimento" id="tipoEstabelecimento">
          <option selected>Tipo de atração</option>
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i> 10h às 18h</li>
                    ...
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-ticket-alt"></i> Sábado é grátis</li>
                        <li class="blog-post-text"><i class="far fa-image"></i> Exposições temporárias</li>
                        <li class="blog-post-text"><i class="fas fa-subway"></i> Fácil acesso ao metrô</li>
                      </ul>
                    </div>
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i> das 10h às 18h</li>
                        <li class="blog-post-text"><i class="fas fa-palette"></i> Obras famosas</li>
                    ...
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-ticket-alt"></i> Terça é grátis</li>
                        <li class="blog-post-text"><i class="far fa-image"></i> Exposições temporárias</li>
                        <li class="blog-post-text"><i class="fas fa-subway"></i> Fácil acesso ao metrô</li>
                      </ul>
                    </div>
    ...
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/museu-de-arte-moderna.jpg" class="img-card img-fluid rounded-start"
                  alt="Museu de Arte Moderna de São Paulo">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Museu de Arte Moderna de São Paulo</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i> das 12h às 18h</li>
                        <li class="blog-post-text"><i class="fas fa-palette"></i> Mais de 5 mil peças</li>
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i> das 9h às 17h</li>
                        <li class="blog-post-text"><i class="fas fa-money-bill-wave"></i> R$5 e R$10</li>
                    ...
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-ticket-alt"></i> Grátis para crianças</li>
                        <li class="blog-post-text"><i class="fas fa-university"></i> Arquitetura clássica</li>
                        <li class="blog-post-text"><i class="fas fa-subway"></i> Fácil acesso ao metrô</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        ...
                        <li class="blog-post-text"><i class="far fa-image"></i> Imagens históricas</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-ticket-alt"></i> Grátis para crianças</li>
                        <li class="blog-post-text"><i class="fas fa-university"></i> Estádio do Pacaembu</li>
                        <li class="blog-post-text"><i class="fas fa-subway"></i> Fácil acesso ao metrô</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
    ...
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/museu-da-lingua-portuguesa.jpg" class="img-card img-fluid rounded-start"
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Museu da Língua Portuguesa</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i> das 9h às 16h30</li>
                        <li class="blog-post-text"><i class="fas fa-money-bill-wave"></i> R$10 e R$20</li>
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        ...
                        <li class="blog-post-text"><i class="fas fa-landmark"></i> Prédio importante</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-ticket-alt"></i> Entrada grátis</li>
                        <li class="blog-post-text"><i class="far fa-image"></i> Exposições temporárias</li>
                        <li class="blog-post-text"><i class="fas fa-subway"></i> Fácil acesso ao metrô</li>
                      </ul>
                    </div>
    ...
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/theatro-municipal-de-sao-paulo.jpg" class="img-card img-fluid rounded-start"
                  alt="Theatro Municipal de São Paulo">
      </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Theatro Municipal de São Paulo</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i> das 10h às 19h</li>
                        <li class="blog-post-text"><i class="fas fa-image"></i> Cartão postal</li>
                        <li class="blog-post-text"><i class="fas fa-landmark"></i> Prédio importante</li>
                      </ul>
                    </div>
                    <div class="float-right">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                    ...
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i> 7h às 21h</li>
                        <li class="blog-post-text"><i class="fas fa-book-reader"></i> Oferece oficinas</li>
                        <li class="blog-post-text"><i class="fas fa-landmark"></i> Prédio moderno</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
    ...
    <div class="row g-0">
      <div class="col-md-4">
         <img src="assets/images/centro-cultural-de-sao-paulo.jpg" class="img-card img-fluid rounded-start"
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Centro Cultural São Paulo</h5>
                  <p class="card-text">4,6 <i class="estrela fas fa-star"></i><a class="card-link" href="#"> (5.034
                      avaliações)</a>
                    <div class="float-left">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-clock"></i>10h às 22h</li>
                        <li class="blog-post-text"><i class="fas fa-book-reader"></i> Oferece oficinas</li>
                        <li class="blog-post-text"><i class="fas fa-landmark"></i> Área para piquenique</li>
                      </ul>
                    </div>
                    <div class="float-right">
                      <ul>
                        <li class="blog-post-text"><i class="fas fa-ticket-alt"></i> Entrada grátis</li>
                        <li class="blog-post-text"><i class="fas fa-theater-masks"></i> Espetáculos</li>
                        <li class="blog-post-text"><i class="fas fa-subway"></i> Fácil acesso ao metrô</li>
                      </ul>
                    </div>
                    <span class="card-body float-right blog-post-preco"><button type="button"
